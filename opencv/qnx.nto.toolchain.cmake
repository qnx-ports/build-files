...
set(PYTHON3_CVPY_SUFFIX .cpython-${PYTHON_VERSION_QNX_ABI}.so)
set(PYTHON_INCLUDE_DIR ${QNX_TARGET}/usr/include/${CPUVARDIR}/python${PYTHON_VERSION_QNX};${QNX_TARGET}/${CPUVARDIR}/usr/include/python${PYTHON_VERSION_QNX};${QNX_TARGET}/usr/include/python${PYTHON_VERSION_QNX};${QNX_TARGET}/${CPUVARDIR}/usr/lib/python${PYTHON_VERSION_QNX}/site-packages/numpy/core/include)
set(PYTHON3_INCLUDE_PATH ${PYTHON_INCLUDE_DIR})
set(PYTHON3_LIBRARY ${QNX_TARGET}/${CPUVARDIR}/usr/lib/libpython${PYTHON_VERSION_QNX}.so)
set(PYTHON3_LIBRARIES ${PYTHON3_LIBRARY})
set(PYTHON3_PACKAGES_PATH ${QNX_TARGET}/${CPUVARDIR}/usr/lib/python${PYTHON_VERSION_QNX}/site-packages)
set(PYTHON3_NUMPY_INCLUDE_DIRS ${QNX_TARGET}/${CPUVARDIR}/usr/lib/python${PYTHON_VERSION_QNX}/site-packages/numpy/core/include)
set(PYTHONLIBS_FOUND)
set(PYTHON_IS_DEBUG FALSE)
set(OPENCV_PYTHON_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/${CPUVARDIR}/usr/lib/python${PYTHON_VERSION_QNX}/site-packages)
