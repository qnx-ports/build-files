...
class TestPackageConan(ConanFile):
    ...
    def layout(self):
        ...
        basic_layout(self, src_folder=os.path.join(project_root,"."), build_folder=os.path.join(project_root,"build_local"))
    ...
    def generate(self):
        ...
        #tc.configure_args = ["--prefix=/usr", "--enable-packet-debug"]
