...
if("$ENV{INSTALL_ROOT}" STREQUAL "")
    message(FATAL_ERROR "INSTALL_ROOT environment variable not found. Please set the variable to the qnx install location")
endif()
...
set(PYTHON_INCLUDE_DIR ${QNX_TARGET}/usr/include/${CPUVARDIR}/python3.11;${QNX_TARGET}/${CPUVARDIR}/usr/include/python3.11;${QNX_TARGET}/usr/include/python3.11;${QNX_TARGET}/${CPUVARDIR}/usr/lib/python3.11/site-packages/numpy/core/include;${QNX_TARGET}/${CPUVARDIR}/usr/local/lib/python3.11/site-packages/numpy/core/include;${INSTALL_ROOT}/${CPUVARDIR}/usr/lib/python3.11/site-packages/numpy/core/include;${INSTALL_ROOT}/${CPUVARDIR}/usr/local/lib/python3.11/site-packages/numpy/core/include)
