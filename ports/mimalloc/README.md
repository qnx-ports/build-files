# mimalloc [![Build](https://github.com/qnx-ports/build-files/actions/workflows/mimalloc.yml/badge.svg)](https://github.com/qnx-ports/build-files/actions/workflows/mimalloc.yml)
...
# Build library
make -C build-files/ports/mimalloc install -j4
```
