...
e.g.
    ...
    - scp ~/build-files/ports/abseil-cpp/nto-aarch64-le/build/bin/* qnxuser@<target-ip-address>:/data/home/qnxuser/bin
    - scp ~/build-files/ports/abseil-cpp/nto-aarch64-le/build/lib* qnxuser@<target-ip-address>:/data/home/qnxuser/
...
**QEMU**: Move abseil library and test binary to qemu instance:
    ...
    - scp ~/build-files/ports/abseil-cpp/nto-x86_64/build/bin/* root<target-ip-address>:/system/xbin
    - scp ~/build-files/ports/abseil-cpp/nto-x86_64/build/lib/lib* root<target-ip-address>:/system/lib
---
