...
e.g.
    ...
    - scp ~/build-files/ports/abseil-cpp/nto-aarch64-le/build/bin/* root<target-ip-address>:/usr/bin
    - scp ~/build-files/ports/abseil-cpp/nto-aarch64-le/build/lib* root@<target-ip-address>:/usr/lib
