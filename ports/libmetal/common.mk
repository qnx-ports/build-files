...
CFLAGS += $(FLAGS) \
          ...
          -D_QNX_SOURCE -D__EXT_UNIX_SOURCE
...
uninstall:
	rm -rf $(QNX_TARGET)/$(CPUVARDIR)/$(PREFIX)/lib/libmetal*
	rm -rf $(QNX_TARGET)/$(CPUVARDIR)/$(PREFIX)/bin/test-metal-*
	rm -rf $(QNX_TARGET)/$(PREFIX)/include/metal
endif
