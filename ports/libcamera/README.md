...
# Build libyaml first
PREFIX="/usr" QNX_PROJECT_ROOT="$(pwd)/libyaml" make -C build-files/ports/libyaml/ install -j4

# Build libcamera
PREFIX="/usr" QNX_PROJECT_ROOT="$(pwd)/libcamera" make -C build-files/ports/libcamera/ install -j4
```
