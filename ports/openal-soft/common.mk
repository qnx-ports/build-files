...
ALL_DEPENDENCIES = openal_all
.PHONY: openal_all install check clean
...
CFLAGS += $(FLAGS) -I$(QNX_TARGET)/$(PREFIX)/include \
...
CMAKE_ARGS = -DCMAKE_TOOLCHAIN_FILE=$(PROJECT_ROOT)/qnx.nto.toolchain.cmake \
    	     ...
    	     -DALSOFT_BACKEND_OSS= $(ALSOFT_BACKEND_OSS) \
             -DALSOFT_BACKEND_ALSA= $(ALSOFT_BACKEND_ALSA) \
             -DALSOFT_BACKEND_PULSEAUDIO= $(ALSOFT_BACKEND_PULSEAUDIO) \
             -DALSOFT_BACKEND_PIPEWIRE= $(ALSOFT_BACKEND_PIPEWIRE) \
             -DALSOFT_BACKEND_JACK= $(ALSOFT_BACKEND_JACK) \
             -DALSOFT_BACKEND_PORTAUDIO= $(ALSOFT_BACKEND_PORTAUDIO) \
             -DALSOFT_RTKIT= $(ALSOFT_RTKIT)
