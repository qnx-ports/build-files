# GSL [![Build](https://github.com/qnx-ports/build-files/actions/workflows/GSL.yml/badge.svg)](https://github.com/qnx-ports/build-files/actions/workflows/GSL.yml)
...
# Build library
make -C build-files/ports/GSL install -j4
```
