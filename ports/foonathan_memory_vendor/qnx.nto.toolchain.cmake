...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Vgcc_nto$ENV{SYSTEM_PROCESSOR} ${EXTRA_CMAKE_C_FLAGS}" CACHE STRING "c_flags")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Vgcc_nto$ENV{SYSTEM_PROCESSOR} -std=gnu++11 ${EXTRA_CMAKE_CXX_FLAGS}" CACHE STRING "cxx_flags")
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -Vgcc_nto$ENV{SYSTEM_PROCESSOR} ${EXTRA_CMAKE_ASM_FLAGS}" CACHE STRING "asm_flags")
...
include_directories(${QNX_INSTALL_ROOT}/usr/include)
include_directories(${QNX_TARGET}/usr/include)

link_directories(${QNX_INSTALL_ROOT}/${SYSTEM_PROCESSOR}/usr/lib)
link_directories(${QNX_TARGET}/${SYSTEM_PROCESSOR}/usr/lib)
