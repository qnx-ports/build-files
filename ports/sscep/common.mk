...
ifeq ($(USE_CUSTOM_SSL),true)
SSL_PATH ?= $(QNX_PROJECT_ROOT)/../install_ssl
endif
...
ifeq ($(USE_CUSTOM_SSL),true)
CFLAGS := -I$(SSL_PATH)/$(PREFIX)/include $(CFLAGS)
LDFLAGS := -L$(SSL_PATH)/$(CPUVARDIR)/$(PREFIX)/lib $(LDFLAGS)
endif

ifeq ($(USE_IOSOCK),true)
CFLAGS := -I$(QNX_TARGET)/usr/include/io-sock $(CFLAGS)
LDFLAGS := -L$(QNX_TARGET)/$(CPUVARDIR)/io-sock/lib $(LDFLAGS)
endif
...
CMAKE_ARGS = -DCMAKE_TOOLCHAIN_FILE=$(PROJECT_ROOT)/qnx.nto.toolchain.cmake \
             ...
             -DBUILD_SHARED_LIBS=$(ENABLE_ENGINES)
