# date [![Build](https://github.com/qnx-ports/build-files/actions/workflows/date.yml/badge.svg)](https://github.com/qnx-ports/build-files/actions/workflows/date.yml)
...
# Build library
make -C build-files/ports/date install -j4
```
