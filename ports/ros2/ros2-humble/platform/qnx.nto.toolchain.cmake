...
set(EXTRA_CMAKE_C_FLAGS "${EXTRA_CMAKE_C_FLAGS} -I${QNX_TARGET}/usr/local/include -Wl,-rpath-link,${QNX_TARGET}/${CPUVARDIR}/usr/lib:${CMAKE_INSTALL_PREFIX}/lib -DOPENCV_NOSTL_TRANSITIONAL -D_QNX_SOURCE")
