# json [![Build](https://github.com/qnx-ports/build-files/actions/workflows/json.yml/badge.svg)](https://github.com/qnx-ports/build-files/actions/workflows/json.yml)
...
# Build library
make -C build-files/ports/json install -j4
```
