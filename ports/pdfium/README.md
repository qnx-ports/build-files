...
The pdfium binaries are located in the directory `<PDFIUM_ROOT>/out`.

The script `pdfium-copy-test-resources-to-target.sh` helps you copy all the required resources to the target directory.
...
```
out/scripts/pdfium-copy-test-resources-to-target.sh ./nto-aarch64-le /data/home/qnxuser/pdfium 10.122.11.3 qnxuser qnxuser
```
