...
# Toolchain file handles compiler flags, include paths, and linker flags.
# Do NOT pass QNX build system CFLAGS/LDFLAGS to cmake — they inject
# -I$(QNX_TARGET)/usr/include which breaks libc++ header ordering.
CMAKE_ARGS = -DCMAKE_TOOLCHAIN_FILE=$(PROJECT_ROOT)/qnx.nto.toolchain.cmake \
             ...
             -DLLAMA_BUILD_TESTS=$(BUILD_TESTING) \
             -DGGML_OPENMP=OFF \
             -DLLAMA_OPENSSL=OFF

ifneq ($(filter aarch64%,$(CPUVARDIR)),)
CMAKE_ARGS += -DGGML_CPU_ARM_ARCH=armv8.2-a+dotprod+fp16 \
              -DGGML_CPU_AARCH64=ON
endif

ifneq ($(filter x86_64%,$(CPUVARDIR)),)
